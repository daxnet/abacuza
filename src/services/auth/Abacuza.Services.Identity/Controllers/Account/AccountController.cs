...
namespace Abacuza.Services.Identity.Controllers.Account
{
    ...
    public class AccountController : Controller
    {
        ...
        private readonly UserManager<AbacuzaAppUser> _userManager;
        private readonly RoleManager<AbacuzaAppRole> _roleManager;
        ...
        public AccountController(
            ...
            UserManager<AbacuzaAppUser> userManager,
            RoleManager<AbacuzaAppRole> roleManager)
        {
        ...
        public async Task<IActionResult> RegisterUser([FromBody] RegisterUserRequestViewModel model)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
            ...
            var appUser = new AbacuzaAppUser
            {
            ...
            if (model.RoleNames?.Count > 0)
            {
                ...
                foreach (var roleName in model.RoleNames)
                {
                    ...
                    if (await _roleManager.RoleExistsAsync(trimmedRoleName))
                    {
                        ...
                        await _userManager.AddToRoleAsync(appUser, trimmedRoleName);
                    }
                }
